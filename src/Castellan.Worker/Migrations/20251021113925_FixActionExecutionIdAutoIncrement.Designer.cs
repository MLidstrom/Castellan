...
namespace Castellan.Worker.Migrations
{
    ...
    [Migration("20251021113925_FixActionExecutionIdAutoIncrement")]
    partial class FixActionExecutionIdAutoIncrement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Castellan.Worker.Models.Chat.ActionExecution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ConversationId", "Status")
                        .HasDatabaseName("IX_ActionExecutions_ConversationStatus");

                    b.HasIndex("Status", "ExecutedAt")
                        .HasDatabaseName("IX_ActionExecutions_StatusExecutedAt");

                    b.ToTable("ActionExecutions");
                });
            ...
            modelBuilder.Entity("Castellan.Worker.Models.Chat.ActionExecution", b =>
                {
                    b.HasOne("Castellan.Worker.Models.Chat.ChatMessage", "ChatMessage")
                        .WithMany()
                        .HasForeignKey("ChatMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Castellan.Worker.Models.Chat.Conversation", "Conversation")
                        .WithMany()
