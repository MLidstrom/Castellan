...
namespace Castellan.Pipeline.Services.ConnectionPools.Interfaces;
...
public interface IQdrantConnectionPool : IDisposable
{
    ...
    Task<IReadOnlyDictionary<string, ConnectionHealth>> GetHealthStatusAsync();
    ...
    /// <param name="isHealthy">Health status to set</param>
    void SetInstanceHealth(string instanceId, bool isHealthy);
}
