...
interface YaraStatistics {
  ...
  topPerformingRules: YaraRulePerformance[];
  slowestRules: YaraRulePerformance[];
  generatedAt: string;
}

interface YaraRulePerformance {
  ruleId: string;
  ruleName: string;
  hitCount: number;
...
interface YaraMatchAnalytics {
  totalMatches: number;
  trends: YaraMatchTrend[];
  ruleEffectiveness: YaraRuleEffectiveness[];
  matchesByCategory: Record<string, number>;
  generatedAt: string;
}

interface YaraMatchTrend {
  timestamp: string;
  matchCount: number;
  groupBy?: string;
  groupValue?: string;
...
interface YaraRuleEffectiveness {
  ruleId: string;
  ruleName: string;
  matchCount: number;
  falsePositiveCount: number;
